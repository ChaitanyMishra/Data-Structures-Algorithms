...
// we Find diffrence between target and one number example - brootForce - 7 + 3 = 10 it use 2 loop 1st i = 7 2nd j = 3 target = 10 but 
// if we do target - arr[i] meens  - 10 - 7 = 3 now we fund is 3 stored in our array if yes we simply return else we store the 3 
class optmized{
    public int[] twoSum(int[] arr , int target){
